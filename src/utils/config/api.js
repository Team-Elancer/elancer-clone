...
//  ============== MAIN BASE URL -> GET ==============
const baseURL = 'http://ec2-43-200-4-171.ap-northeast-2.compute.amazonaws.com:8080';

// ==============  BASE URL -> (GET), POST, PUT, DELETE ==============
export const BaseUrl = 'http://ec2-43-200-4-171.ap-northeast-2.compute.amazonaws.com:8080';
