export const ETC_LIST = [
  ...
  {
    qsymbol: '[Q]',
    question: '㈜Encer가 일반 잡 포탈(Job Portal) 서비스와 다른 점은 무엇인가요?',
    asymbol: '[A]',
    answer: `(주)Encer의 특별한 서비스에 대해 알고 싶으신가요? ㈜Encer는 2014년 기준 15년의 사업이력을 가진 전통 있는 IT인재 아웃소싱 전문기업입니다.IT 지식에 해박한 매니저들이 24시간 대기 중인 ㈜Encer는 다년간 축적된 IT인재 마켓플레이스 거래정보 DB의 구직자 경력을 기업에게 제공해 11년간 신뢰를 쌓아왔습니다. 또한 매니저들은 정확한 일자리 정보를 구직자에게 제공하는 1:1 매칭 서비스를 선보입니다. 자의적으로 작성한 구인/구직정보가 검증 없이 등록되고 공유되는 일반 잡 포탈과는 확연히 다른 장점을 가지고 있는 셈입니다. 그리고 ㈜Encer를 통해 중개계약을 진행하게 되면, 단독거래 시 동반되는 임금체불, 불공정거래 등에서 보호될 수 있습니다. ㈜Encer에는 전담법무팀이 있어 IT개발자들에게 공정한 고용계약과 안정적인 개발비용 지급을 약속드릴 수 있습니다. 일반 잡 포탈과 ㈜Encer의 차이점에 대해서 궁금한 점은 풀리셨나요? Encer는 앞으로도 오랫동안 IT인재들의 든든한 친구가 될 예정입니다.`,
  },
  {
    qsymbol: '[Q]',
    question: '㈜Encer는 e랜서와 바이어 중 누구의 편에 서나요?',
    asymbol: '[A]',
    answer: `e랜서로 활동하시면서 ㈜Encer가 누구의 편에 서는지 궁금하셨군요? ㈜Encer는 심판의 역할을 합니다. 마켓플레이스는 개방된 장터입니다. 기업회원들은 일할 기회인 프로젝트를 내놓고, e랜서는 경험으로 기술을 파는 역할을 하는 것이지요. ㈜Encer는 마켓플레이스에서 먹튀와 악덕을 감시하는 역할을 합니다. 하지만 ㈜Encer는 상대적으로 약자의 입장에 있는 e랜서의 편에 많이 서는 편입니다. 그러니 ㈜Encer를 믿고 마켓플레이스에서 마음껏 실력을 펼치시면 됩니다.`,
  },
  {
    qsymbol: '[Q]',
    question: '담당 매니저가 왜 달라지나요?',
    asymbol: '[A]',
    answer: `Encer 회원 분들 중에 가끔 매니저가 바뀌는 상황을 물어보실 때가 있습니다. 그 이유는 프로젝트마다 담당 매니저 배정이 다르기 때문에 그렇습니다. 프로세스를 설명 드리자면, 프로젝트가 등록이 된 후 담당매니저가 배정, 초기 상담을 진행하고 프리랜서 서칭에 들어가게 됩니다. 이때 프로젝트 담당 매니저가 모든 것을 다 하는 것이 아니라 때로는 다른 매니저들도 함께 컨택을 하는 경우도 있습니다. 바이어쪽과 직접 상담을 통해서 해당 프로젝트에 대해 제일 잘 알고 있는 담당매니저가 다른 매니저들과 정보 공유를 하고 거기에 맞게 인재서칭을 하는 것이지요. 이제 '담당이 다르다고?'라며 의아하게 생각하지 마세요! 궁금한 점이 있으시면 얼마든지 물어보세요.`,
  },
];
