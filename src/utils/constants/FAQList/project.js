export const PROJECT_LIST = [
  ...
  {
    qsymbol: '[Q]',
    question: '(주)이랜서 입금일이 변경 되었나요?',
    asymbol: '[A]',
    answer: `2012년 9월부터 (주)이랜서 회계처리에 따라 입금 처리가 약간 변경 되었습니다. - 기존 : 바이어로부터 입금 받는 날로부터 영업일 기준 5일 후 지급하던 방식이었습니다. - 변경 : 1일~15일 중 바이어에게 입금 받으면 '15일에 지급', 16일~말일 입금 받으면 '말일 지급' 방식으로 바뀌게 되었습니다. 9월부터 계약하는 분들과 현재 진행되는 사항이고, 이 점에 관해서는 매니저들이 충분히 안내드리고 진행을 합니다. 열심히 일한 개발자분들이 마땅한 대가를 제때 지급 받으실 수 있도록 매니저들도 열심히 뛰고 있습니다.`,
  },
  {
    qsymbol: '[Q]',
